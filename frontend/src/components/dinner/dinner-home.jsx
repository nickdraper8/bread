...
class DinnerHome extends React.Component {
  ...
  handleAddAttendee(e) {
    ...
    newState[e._dispatchInstances.key] = this.props.users[
      e._dispatchInstances.key
    ];
    this.setState({
      attendees: newState,
      errors: [],
  ...
  handleSubmit(e) {
    ...
    if (attendeeIds.length < 1) {
      this.setState({
        errors: [
          "You must include at least one user! Use the search bar to find users",
        ],
      });
  ...
  render() {
       ...
       if (Object.values(this.state.attendees).length > 0) {
         ...
         attendeesList = (
           <div className="user-search-result-item">No Users Added Yet!</div>
         );
       }
    ...
    return (
      <div className="user-home-container">
        ...
        <div className="right-user-home-container">
          ...
          <div id="event-form-container-dinner">
            <h1>Host Dinner</h1>
            <div id="form-items-container">
              ...
              <div className="event-form-details-container">
                <form onSubmit={this.handleSubmit}>
                  <input
                    className="event-name-host-dinner-input"
                    type="text"
                  ...
                  />
                  {/* <button
                    className="event-name-host-dinner-button"
                    type="submit"
                  >
                    Create
                  </button> */}
